%
% Generation of the training set for the Bouc Wen benchmark.
% It is adapted from the example file BoucWen_ExampleIntegration.m
% by J.P. Noel(1), M. Schoukens(2), and available within the Bouc Wen benchmark
% at the address http://nonlinearbenchmark.org/FILES/BENCHMARKS/BOUCWEN/BoucWenFiles.zip
% However, we save the result in hdf5 format for easier use in python.
% To run this script, you also need to copy in this folder the file BoucWen_NewmarkIntegration.p
% also available in the zip file  http://nonlinearbenchmark.org/FILES/BENCHMARKS/BOUCWEN/BoucWenFiles.zip
