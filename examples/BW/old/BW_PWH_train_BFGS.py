...
if __name__ == '__main__':
    ...
    optimizer_LBFGS = torch.optim.LBFGS(list(G1.parameters()) + list(G2.parameters()) + list(F_nl.parameters()), lr=lr_BFGS, tolerance_grad=1e-7, line_search_fn='strong_wolfe')
