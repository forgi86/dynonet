...
if __name__ == '__main__':
    ...
    model_load_name = "model_BW_PBO_LBFGS"
    model_save_name = "model_BW_PBO_LBFGS_refined"
    ...
    num_iter_ADAM = 0*1000#5000 or 4000
    ...
    params = list(G1.parameters()) + list(F1.parameters()) + list(G2.parameters()) + list(F2.parameters()) + list(G3.parameters())
    ...
    plt.grid(True)
    fig_name = 'loss.pdf'
    plt.savefig(os.path.join("models", model_load_name, fig_name))
